...
// @ts-ignore
export const GEMINI_API_KEY_REFERENCE = import.meta.env.VITE_GEMINI_API_KEY || ""; // For general reference, not client init
// Gemini API client in apiService.ts will use process.env.API_KEY directly.
...
// Corrected agenda file URLs to be absolute from public/
translations.es.buenosaires_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.he.buenosaires_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.es.rosario_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.he.rosario_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.es.bariloche_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.he.bariloche_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.es.mendoza_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.he.mendoza_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.es.malargue_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.he.malargue_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.es.jujuy_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.he.jujuy_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.es.iguazu_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.he.iguazu_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.es.corrientes_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.he.corrientes_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.es.ibera_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
translations.he.ibera_events_agenda_link_url = "/docs/agenda/ariflier1970@gmail.com.ical.zip";
